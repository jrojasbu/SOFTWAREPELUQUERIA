    ...
    try {
        ...
        if (result.status === 'success') {
            ...
            if (historical.length === 0) {
                ...
                if (div) {
                    div.style.display = 'block';
                    div.innerHTML = 'No hay datos suficientes para mostrar la demanda de servicios. Verifica que haya servicios registrados en los últimos 11 meses para la sede seleccionada.';
                }
                return;
            }
